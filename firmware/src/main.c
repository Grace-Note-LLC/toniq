...
#define EPD_WIDTH 200 // Width is the smaller dimension for buffer calculation
#define EPD_HEIGHT 200 // Height is the larger dimension
...
int main(void) {
	...
	// eink_draw_text(10, 10, "Hello World!");

	// // Example: Update with an image (you'll need to provide the image data)
	// // uint8_t image_data[EPD_BUFFER_SIZE];
	// // eink_update_full(image_data);

	// // Power off the display when done
	// eink_power_off();
